...
- **SELL / SALVAGE** — what the character is carrying that earns no place: off-build gear, outleveled drops, the whole "Carried but unranked" list unless an entry is genuinely worth keeping. Stash items never appear here — see the disposition rule below.
