...
> Depends on Stage 5A (mechanics layer) and 5A.2 (requirements & attributes): the resistance matrix, damage profile, skill/devotion/set/affix data, attribute totals, requirement reductions and per-item requirements all come from there. This stage renders; it does not compute game mechanics.
